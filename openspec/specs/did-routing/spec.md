# did-routing Specification

## Purpose

The DID-to-tenant table loaded from resources/config/routes.json, resolving the tenant for an inbound trunk call from the dialed DID. There is no default tenant: an unmapped DID is rejected.
