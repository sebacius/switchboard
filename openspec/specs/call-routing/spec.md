# call-routing Specification

## Purpose

Tenant and direction resolution for every call: direction as a trust gradient (internal, inbound, outbound), tenant derivation with no default, and the Call Context block prepended to the tenant system prompt.
## Requirements
